...
format:
	...
	go run github.com/incu6us/goimports-reviser/v3@$(GOIMPORTS_REVISER_VERSION) -project-name github.com/bborbe/obsidian-lint -format -excludes vendor ./...
...
.PHONY: build
build:
	@go build -mod=mod -o bin/obsidian-lint main.go
